...
const Localization = new LocalizedStrings({
 es: {
   ...
   fame_description: 'Los paquetes de tiempo + fama te permitirán a aparecer en el dashboard de otros OWA Influencers, y muy pronto dentro de nuestras otras aplicaciones. Estos paquetes también te otorgan tiempo para la automatización.',
 ...
 en:{
   ...
   fame_description: 'Time + Fame packages will allow you to appear in the dashboard of other OWA Influencers, and very soon within our other applications. These packages also give you time for automation.',
